...
| 对话练习界面 | 场景选择界面 | 发音评测与总结 |
|:---:|:---:|:---:|
| ![对话练习界面](screenshots/chat-preview.png) | ![场景选择界面](screenshots/scenario-preview.png) | ![发音评测与总结](screenshots/summary-preview.png) |
| *AI 实时语音对话练习* | *多种练习场景选择* | *发音评分与多维度能力评估* |
